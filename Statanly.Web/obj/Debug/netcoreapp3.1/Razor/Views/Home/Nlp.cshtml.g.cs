#pragma checksum "C:\Users\serge\OneDrive\Рабочий стол\Statanly landing\Landing\Statanly.Web\Views\Home\Nlp.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "52ca9cd247b6107c35f57448291f4346cb8fea1a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"52ca9cd247b6107c35f57448291f4346cb8fea1a", @"/Views/Home/Nlp.cshtml")]
           ...
           ");
            WriteLiteral(@"             <strong>Структурированное извлечение данных из документов</strong>
                    ...
                    <li>
                        ...
                        Локальный аналог ChatGPT по специализированной документной базе. Разрабатываем, используя ""generic"" LLM, обученную на большом массиве данных и дополняя решение поиском по базе знаний, специфичной для определенного домена. Подходит, например, если необходима система помощи для работы с внутренней базой знаний компании. В качестве документной базы могут быть различные типы информации, не только текст. Можно в базу добавить");
            WriteLiteral(@" картинки, звук и таблицы. Как отдельный пункт можно добавить RAG с использованием интернет браузера (вместо коллекции документов -  интернет). Пример - <strong>BingChat</strong>.
                    </li>
                    <li>
    ...
    ");
            WriteLiteral(@"                <li>
                    ...
                    <li>
                        ...
                        Выделение нужной информации из больших текстов и неструктурированных документов в компактный вид, резюме, краткое содержание, выделение основных тем, положений и смысла. В качестве примеров – сервис для генерирования краткого ");
            WriteLiteral(@"содержания по субтитрам из ютуб видео или сервис для автоматического составления meeting notes после важной видеоконференции
                    </li>
                    <li>
                        <strong>
                    ...
                    <li>
                        ...
                        Может быть частью сервиса. Например, для банковского приложения можно облегчить жизнь своему ");
            WriteLiteral(@"call-центру. В него могут приходить вопросы на разных языках и разного уровня структуризации. Можно комбинировать с пунктами  2, 5, 6, 7, 9 для создания такого сервиса эффективно. Дополнительно можно сделать модели перевода с любых языков
                    </li>
                    <li>
                        <strong>
       ...
       ");
            WriteLiteral(@"                 </br>
                        ...
                        Инструменты, такие как: поиск в интернете, wolfram, переводчик, калькулятор, пойти");
            WriteLiteral(@" в базу данных, да что угодно в принципе
                        ...
                        <code>
                            ...
                            Thought: Now I know who is Brad Pit");
            WriteLiteral(@"t's girlfriend. I need to find her age and take it to the power of 2.
                            Action: web_search
       ...
       ");
            WriteLiteral(@"             </li>
                    ...
                    <li>
                        ...
                        Системы перефразирования текстов (задача п");
            WriteLiteral("арафраза), когда необходимо, возможно в сжатом виде пересказать определенной статью, текст, заметку.\r\n                    </li>\r\n                </ul>\r\n\r\n\r\n\r\n            </div>\r\n            <div class=\"col-lg-4\">\r\n                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "52ca9cd247b6107c35f57448291f4346cb8fea1a17391", async() => {
            }
            );
